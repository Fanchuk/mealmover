        ...
        <div className="relative w-full h-[380px] sm:h-[500px] lg:h-[619px] rounded-[30px] lg:rounded-[40px] overflow-hidden">
          ...
          <div className="absolute top-5 left-5 z-10">
            <a
              ...
              className="flex items-center gap-2 bg-white rounded-[50px] h-[48px] px-5 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.15)] font-heading font-medium text-[16px] text-[#EF5B5B] hover:shadow-md transition-shadow"
            >
              View Large Map <ArrowUpRight size={16} />
            </a>
          </div>
        </div>
      </div>
