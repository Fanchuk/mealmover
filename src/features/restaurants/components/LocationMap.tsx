  ...
  return (
    <section id="location" className="bg-white py-8 lg:py-12">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
        ...
        <div className="relative w-full h-[360px] rounded-[24px] overflow-hidden border border-neutral-200 bg-neutral-100">
          <iframe
            title={`Map of ${name}`}
            src={src}
          ...
          />
          <div className="absolute bottom-4 left-4 z-10 bg-white rounded-[16px] px-4 py-3 shadow-lg flex items-center gap-2 max-w-[80%]">
