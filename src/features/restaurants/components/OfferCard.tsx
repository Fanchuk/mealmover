...
export function OfferCard({ id, name, desc, price, oldPrice, image, restaurantId, restaurantName, onOpenModal }: Props) {
  ...
  return (
    ...
    >
      <button onClick={onOpenModal} className="overflow-hidden block cursor-pointer flex-shrink-0" aria-label={`Customize ${name}`}>
      ...
      <div className="p-5 flex flex-col gap-2 flex-1">
        ...
        <p className="font-heading font-light text-[16px] sm:text-[20px] text-neutral-500 line-clamp-1">{desc}</p>
